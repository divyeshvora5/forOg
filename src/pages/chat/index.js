...
const chatPage = () => {
    ...
    const handleUserRoute =(address) => {
      if(!address)return;
      push(PATH_DASHBOARD.user.detail(address))
    }
    return (
      <>
                    ...
                    <div className='chat-body-wrapper'>
                      <form
                        ...
                        <div className='chat-body-header-wrapper'>
                          <div className='chat-user-header pointer' onClick={()=>handleUserRoute(selectedChat?.recipient?.address)}>
                            <div className='user-img-div'>
                                ...
                                messages.map((message, index) => (
                                  <div
                                    ...
                                    <div className='message-box-time-text'>
                                      ...
                                      <span className='msg-title-text'>{moment(message?.createdAt).fromNow()}</span>
                        ...
                        <div className='chat-footer-wrapper-div'>
                          ...
                          <div className='chat-textarea-wrapper'>
                            <textarea
                              ...
                              name='message'
                              value={newMessage}
                              onChange={handleInputMessage}></textarea>

          ...
          <div className='home-slider-main-item'>
            <div className='home-slider-main-img'>
              <div
                ...
                <BackgroundGradient
                  ...
                  <ImageLoader src={item?.image} thumbnail={item?.thumbnail} alt={item?.name} style={{}} />
                </BackgroundGradient>
              </div>
            ...
            <div className='home-slider-main-content'>
              <div className='home-slider-main-content-text'>
                <h3>Base on TesseractX</h3>
                <p>
                  Base is officially live on The TesseractX Marketplace. Buy, sell and create your Base NFTs - right
                  here on TesseractX
                </p>
              </div>
              {/* <h3>{item?.name}</h3> */}
              ...
              <div className='btn-group-main'>
                ...
                <Button onClick={handleRouteChange} isBorderBtn={true} className='border-dark-button'>
                  {/* View Details */}
                  Read More
                </Button>
              </div>
